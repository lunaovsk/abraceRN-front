const modalManager = {
    ...
    ocultarCamposAdicionais() {
        document.getElementById('modalTamanhoContainer').style.display = 'none';
    ...
    handleTipoChange(tipo) {
        ...
        document.getElementById('modalTamanhoContainer').style.display = mostrarTamanho ? 'block' : 'none';
    },
    ...
    validarFormulario() {
        ...
        if ((categoria === 'roupa' || categoria === 'acessorio') &&
            ...
            document.getElementById('modalTamanhoContainer').style.display === 'block') {
